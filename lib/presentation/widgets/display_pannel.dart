...
import 'package:wordle/presentation/widgets/input_pannel.dart';
            ...
            if (event is KeyDownEvent) {
              if (event.logicalKey.keyLabel != null &&
                ...
                InputNotification(
                        ...
                        msg: event.logicalKey.keyLabel.toUpperCase())
                    .dispatch(innerContext);
                return KeyEventResult.handled;
              } else if (event.logicalKey == LogicalKeyboardKey.backspace) {
                const InputNotification(type: InputType.backSpace, msg: "")
                    .dispatch(innerContext);
                return KeyEventResult.handled;
